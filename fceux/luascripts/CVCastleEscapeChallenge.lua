...
local saveStatePath = "../fcs/CV1CastleEscape.fcs"
...
while true do
    ...
    -- Display Title 
    coreFcn.display_title({"Castlevania - Castle Escape Challenge"})

    -- Display Instructions
    if message_timer > 0 then
        coreFcn.display_centered_message({"Get out of the castle!"})
    ...
    if memory.readbyte(0x0011) == 0x02  then
