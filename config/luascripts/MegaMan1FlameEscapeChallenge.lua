...
local instructions = { "Escape the Flames! - Go Up!" }
...
local saveStatePath = "../fcs/MegaMan1.challenge08.fcs"
...
function check_victory()
    if memory.readbyte(0x001B) >= 0x000C then
        ...
        -- Ensure start_frame is not nil before performing arithmetic
            ...
            coreFcn.display_centered_message({
                "Congrats! You Escaped the Flames!",
...
while true do
    ...
    coreFcn.display_footer("MegaMan Challenge - Escape the Flames!")
