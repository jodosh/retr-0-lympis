...
local instructions = { "Defeat CutMan!" }
...
local saveStatePath = "../fcs/MegaMan1.challenge03.fcs"
    ...
    if memory.readbyte(0x06C1) <= 0x0000 then
        ...
        -- Ensure start_frame is not nil before performing arithmetic
            ...
            coreFcn.display_centered_message({
                "Congrats! You completed Cut Man!",
...
while true do
    ...
    coreFcn.display_footer("MegaMan Challenge - Defeat Cut Man!")
