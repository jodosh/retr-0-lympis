...
local saveStatePath = "../fcs/MegaMan1.challenge02.fcs"
...
function check_victory()
    if memory.readbyte(0x001A) >= 0x0000 and memory.readbyte(0x001B) == 0x000D then
        ...
        -- Ensure start_frame is not nil before performing arithmetic
            ...
            coreFcn.display_centered_message({
                "Congrats! You completed the Climb Up!",
...
while true do
    coreFcn.display_footer("MegaMan Challenge - Climb Up!")
